...
pin_assignment: pin_variable = identifier Assign value = pin_value SemiColon; // See Syntax 68, 9.3.2
...
limit_arithmetic_submodel: submodel = identifier OpenSwirly violation? alf_min_alf_max CloseSwirly;
